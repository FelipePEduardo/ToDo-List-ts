...
interface TaskProps {
  ...
  onCheckTask: (e: ChangeEvent<HTMLInputElement>, id:string) => void;
}

export function Task({id, content, onDeleteTask, onCheckTask}:TaskProps) {
  function handleDeleteTask() {
    onDeleteTask(id)
  }

  function handleCheckTask(e: ChangeEvent<HTMLInputElement>) {
    onCheckTask(e, id)
  }
